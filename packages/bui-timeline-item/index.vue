...
<style lang="scss" src="../../theme/css/timeline.scss"></style>
...
export default {
  ...
  computed: {
    ...
    tailClasses() {
      return [
        `${prefixCls}-item-tail`,
        this.first ? `${prefixCls}-item-tail-first` : "",
        this.last ? `${prefixCls}-item-tail-last` : ""
      ];
    },
    headClasses() {
      return [
        `${prefixCls}-item-head`,
        this.dot ? `${prefixCls}-item-head-custom` : "",
        this.headColorShow ? `${prefixCls}-item-head-${this.color}` : ""
      ];
    },
    headColorShow() {
      return (
