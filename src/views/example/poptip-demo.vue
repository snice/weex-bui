...
export default {
  data: function() {
    return {
      ...
      pos : {},
      title : '电影简介',
      content : '《神奇动物在哪里》是由美国华纳兄弟影片公司、英国盛日影业公司联合出品的奇幻冒险电影，由英国导演大卫·叶茨执导，埃迪·雷德梅恩、凯瑟琳·沃特斯顿、艾莉森·苏朵儿、丹·福格勒、柯林·法瑞尔等联合主演。该片讲述了神奇动物学家纽特·斯卡曼德离开霍格沃兹魔法学校后，为了寻找和保护神奇动物踏入纽约所发生的一段惊心动魄的冒险故事。该片于2016年11月18日在美国上映，2016年11月25日在中国上映。',
    }
  },
  methods: {
    back() {
